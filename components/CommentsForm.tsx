...
const CommentsForm = ({ slug } : { slug: any }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8 z-50">
      <h3 className="text-xl mb-8 font-semibold border-b pb-4 pl-1">
        Leave a Reply
      </h3>
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="text-gray-500 cursor-pointer px-4" htmlFor="storeData">
            Save my name for future references!
          </label>
        </div>
      </div>
